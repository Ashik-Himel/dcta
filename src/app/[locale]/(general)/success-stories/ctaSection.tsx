import successStoriesImg2 from "@/assets/section-images/success-stories-img-2.jpg";
...
export default function CtaSection() {
  const t = useTranslations("SuccessStoriesPage.CtaSection");
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/courses#courses">{t("explore-courses")}</Link>
              </Button>
            </div>
          </div>
          <Image
            src={successStoriesImg2}
            alt="Success Stories Page Image"
