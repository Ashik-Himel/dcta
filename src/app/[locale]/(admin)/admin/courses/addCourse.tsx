...
import { Badge, Category } from "@/lib/models";
...
export default function AddCourse() {
  ...
  const handleSlugChange = async (slug: string) => {
    ...
    const res = await fetch(`${serverDomain}/api/courses/slug/${slug}`);
  ...
  const handleAddCourse = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const response = await fetch(`${serverDomain}/api/courses`, {
      method: "POST",
      headers: {
  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="duration">
                Course Duration{" "}
                <small className="text-xs text-gray pt-0.5">(months)</small>
              </Label>
              <Input
                type="number"
                id="duration"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="grid gap-2">
              <Label htmlFor="thumbnail">
                Course Thumbnail{" "}
                <small className="text-xs text-gray pt-0.5">(512x288)</small>
              </Label>
              <Input
                type="file"
                id="thumbnail"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-end gap-4">
            <div className="grid gap-2">
              <Label htmlFor="badge">
                Select Badge{" "}
                <small className="text-xs text-gray pt-0.5">(Optional)</small>
              </Label>
        ...
        <DialogFooter>
          <Button type="submit" form="add-course-form" disabled={submitting}>
